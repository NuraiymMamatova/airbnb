...
@Component
@NoArgsConstructor
public class HouseResponseForUser implements MarkerService {
    ...
    public HouseResponseForUser(Long id, String title, String descriptionOfListing, Long maxOfGuests, HouseType houseType) {
        this.id = id;
        this.title = title;
