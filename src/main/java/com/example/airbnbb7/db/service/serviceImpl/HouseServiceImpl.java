...
public class HouseServiceImpl implements HouseService {
    ...
    public ApplicationResponse getAllPagination(String search, String region, String popularOrTheLatest, String homeType, String price, Long page, Long pageSize, double userLatitude, double userLongitude) throws IOException {
        ...
        if (search != null) {
            List<HouseResponseSortedPagination> houseResponseSortedPaginations = new ArrayList<>(getAllPagination(page, pageSize, houseRepository.searchByQuery(search)));
            private List<HouseResponseSortedPagination> sortHomeType (String region, String popularOrTheLastest, String
            homeType){
                List<HouseResponseSortedPagination> houseResponseSortedPaginations = new ArrayList<>();
            ...
            applicationResponse.setPaginationList(houseResponseSortedPaginations);
            return applicationResponse;
            private List<HouseResponseSortedPagination> sortPrice (String region, String popularOrTheLastest, String
            homeType, String price){
            ...
            private List<HouseResponseSortedPagination> getAllPagination (Long page, Long
            size, List < HouseResponseSortedPagination > houseResponseSortedPaginations){
            ...
            private List<HouseResponseForAdmin> getProfileHouseResponse (Long page, Long
            size, List < HouseResponseForAdmin > profileHouseResponses){
                int startItem = (int) ((page - 1) * size);
            ...
            @Override
            public List<HouseResponseSortedPagination> getAllHousing (HousesBooked housesBooked, String
            houseType, String price, String popularOrTheLatest) throws IOException {
            ...
            @Override
            public List<HouseResponseSortedPagination> searchNearby ( double userLatitude, double userLongitude) throws
            IOException {
            ...
            private List<HouseResponseSortedPagination> sortRegion (String region,double[] coordinates) throws
            IOException {
                if (region == null) region = "All";
            ...
            private List<HouseResponseSortedPagination> sortPopularOrTheLatest (String region, String popularOrTheLatest,
            double[] coordinates) throws IOException {
            ...
            private List<HouseResponseSortedPagination> sortHomeType (String region, String popularOrTheLastest, String
            homeType,double[] coordinates) throws IOException {
                List<HouseResponseSortedPagination> houseResponseSortedPaginations = new ArrayList<>();
                ...
                if (homeType.equals("All"))
                    return popularOrTheLatest /*sortPopularOrTheLatest(region, popularOrTheLastest)*/;
                if (homeType.equals("Apartment")) {
            ...
            private List<HouseResponseSortedPagination> sortPrice (String region, String popularOrTheLastest, String
            homeType, String price,double[] coordinates) throws IOException {
